...
# -*- coding: utf-8 -*-
#
# My math tutorial documentation build configuration file, created by
# sphinx-quickstart on Sun Sep 17 16:59:43 2017.
#
...
# documentation.
#
html_theme_options = {'page_width': '1300px'}
...
htmlhelp_basename = 'mathtutorialdoc'
...
latex_documents = [
    (master_doc, 'mathforprogrammers.tex', 'Math for programmers',
     'Akuli', 'manual'),
]
...
man_pages = [
    (master_doc, 'mathforprogrammers', 'Math for programmers',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mathforprogrammers', 'Math for programmers',
     author, 'mathforprogrammers', 'One line description of project.',
     'Miscellaneous'),
]
